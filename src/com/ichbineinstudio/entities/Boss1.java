...
public class Boss1 extends Entity{
	...
	private double life = 85, maxLife = 85;
	...
	public Boss1(int x, int y, int width, int height, BufferedImage sprite) {
		...
		sprites[0] = Game.spritesheet.getSprite(8*16, 8*16, 32, 32);
	    sprites[1] = Game.spritesheet.getSprite(6*16, 8*16, 32, 32);
	    sprites[2] = Game.spritesheet.getSprite(4*16, 8*16, 32, 32);
	    
	    sprites2 = new BufferedImage[3];
		sprites2[0] = Game.movements.getSprite(15*16, 8*16, 32, 32);
	    sprites2[1] = Game.movements.getSprite(13*16, 8*16, 32, 32);
	    sprites2[2] = Game.movements.getSprite(11*16, 8*16, 32, 32);
	    
	    sprites3 = new BufferedImage[3];
		sprites3[0] = Game.movements.getSprite(6*16, 19*16, 32, 32);
	    sprites3[1] = Game.movements.getSprite(4*16, 19*16, 32, 32);
	    sprites3[2] = Game.movements.getSprite(2*16, 19*16, 32, 32);
	    
	    sprites4 = new BufferedImage[3];
		sprites4[0] = Game.movements.getSprite(15*16, 19*16, 32, 32);
	    sprites4[1] = Game.movements.getSprite(13*16, 19*16, 32, 32);
	    sprites4[2] = Game.movements.getSprite(11*16, 19*16, 32, 32);
	}
		...
		//	if(Game.rand.nextInt(100) < 30) {
			...
			if((int)y < Game.player.getY() && World.isFreeForBosses(this.getX(),(int)(y+speed), width, height)
				...
				Game.player.life-=(Game.rand.nextInt(10)+1);
		...
		//    g.fillRect(this.getX() + maskx - Camera.x, this.getY() + masky - Camera.y, maskw,maskh);
				...
				if(Game.texture == "Texture_ONE") {
				g.drawImage(Entity.BOSS_1_FEEDBACK,this.getX() - Camera.x,this.getY() - Camera.y,null);
				}else if(Game.texture == "Texture_TWO") {
				g.drawImage(Entity.BOSS_1_FEEDBACK_TEXTURE2,this.getX() - Camera.x,this.getY() - Camera.y,null);		
				}else if(Game.texture == "Texture_THREE") {
				g.drawImage(Entity.BOSS_1_FEEDBACK_TEXTURE3,this.getX() - Camera.x,this.getY() - Camera.y,null);			
				}else if(Game.texture == "Texture_FOUR") {
				g.drawImage(Entity.BOSS_1_FEEDBACK_TEXTURE4,this.getX() - Camera.x,this.getY() - Camera.y,null);	
				}
            ...
            g.drawString("Müller", (this.getX()-1) - (Camera.x), (this.getY() +40) - (Camera.y));
