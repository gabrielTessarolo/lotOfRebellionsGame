...
public class Boss2 extends Entity{
	...
	public Boss2(int x, int y, int width, int height, BufferedImage sprite) {
		...
		sprites[0] = Game.movements.getSprite(6*16, 6*16, 32, 32);
	    sprites[1] = Game.movements.getSprite(4*16, 6*16, 32, 32);
	    sprites[2] = Game.movements.getSprite(2*16, 6*16, 32, 32);
	    
	    sprites2 = new BufferedImage[3];
		sprites2[0] = Game.movements.getSprite(15*16, 6*16, 32, 32);
	    sprites2[1] = Game.movements.getSprite(13*16, 6*16, 32, 32);
	    sprites2[2] = Game.movements.getSprite(11*16, 6*16, 32, 32);
	    
	    sprites3 = new BufferedImage[3];
		sprites3[0] = Game.movements.getSprite(6*16, 17*16, 32, 32);
	    sprites3[1] = Game.movements.getSprite(4*16, 17*16, 32, 32);
	    sprites3[2] = Game.movements.getSprite(2*16, 17*16, 32, 32);
	    
	    sprites4 = new BufferedImage[3];
		sprites4[0] = Game.movements.getSprite(15*16, 17*16, 32, 32);
	    sprites4[1] = Game.movements.getSprite(13*16, 17*16, 32, 32);
	    sprites4[2] = Game.movements.getSprite(11*16, 17*16, 32, 32);
	}
		...
		//	if(Game.rand.nextInt(100) < 30) {
			...
			if((int)y < Game.player.getY() && World.isFreeForBosses(this.getX(),(int)(y+speed), width, height)
				...
				Game.player.life-=(Game.rand.nextInt(12)+1);
		...
		//    g.fillRect(this.getX() + maskx - Camera.x, this.getY() + masky - Camera.y, maskw,maskh);
				...
				if(Game.texture == "Texture_ONE") {
				g.drawImage(Entity.BOSS_2_FEEDBACK,this.getX() - Camera.x,this.getY() - Camera.y,null);
				}else if(Game.texture == "Texture_TWO") {
				g.drawImage(Entity.BOSS_2_FEEDBACK_TEXTURE2,this.getX() - Camera.x,this.getY() - Camera.y,null);
				}else if(Game.texture == "Texture_THREE") {
				g.drawImage(Entity.BOSS_2_FEEDBACK_TEXTURE3,this.getX() - Camera.x,this.getY() - Camera.y,null);
				}else if(Game.texture == "Texture_FOUR") {
				g.drawImage(Entity.BOSS_2_FEEDBACK_TEXTURE4,this.getX() - Camera.x,this.getY() - Camera.y,null);	
				}
			}
		/*	if(Game.texture == "Texture_ONE" || Game.texture == "Texture_TWO") {
			...
			g.drawString(this.life+"/"+this.maxLife, (this.getX() + 7) - (Camera.x), (this.getY() - 4) - (Camera.y));*/
		//	}else*/ if(Game.texture == "Texture_THREE") {
			...
			g.drawString(this.life+"/"+this.maxLife, (this.getX() -3) - (Camera.x), (this.getY() - 4) - (Camera.y));		
	            ...
	            g.drawString("Hazzard", (this.getX()-4) - (Camera.x), (this.getY() +40) - (Camera.y));
